{
    ...
    'license': 'LGPL-3',
    'depends': ['mail','hr_contract','hr_holidays',],
    'data': [
        ...
        'report/report_negative_monthly.xml',
        'report/report_positive_salary.xml',
        ...
        'wizard/payslip_negative_salary.xml',
        ...
        'views/payroll_mass_computation.xml',
