...
class RetaManagementDashboard(models.Model):
    _name = 'reta.management.dashboard.data'
...
class ManagementDashBoardCio(models.Model):
    ...
    def management_dashboard_cio(self):
        return {
            'name': _('CIO'),
    ...
    def management_dashboard_release_orders(self):
        return {
            ...
            'res_model': 'sale.order',
            'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
            'domain': [('reta_bool_field', '=', True),('reta_state', '=', 'sale')],
            'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                      (self.env.ref('eenadu_reta.reta_tree_view').id or False, 'tree')],

        }

    def management_dashboard_payment_collections(self):
        return {
            ...
            'res_model': 'sale.order',
            'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
            'domain': [('reta_bool_field', '=', True), ('reta_state', '!=', 'cancel')],
            'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                      (self.env.ref('eenadu_reta.reta_tree_view').id or False, 'tree')],
