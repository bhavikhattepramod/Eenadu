odoo.define('eenadu_reta.reta_dashboard', function (require){
   ...
   var reta_dashboard_main = AbstractAction.extend({
      ...
      render_dashboards: function(){
         ...
         fetchPieChartData: function () {
            ...
            .then(function (data) {
               //Product Pie Chart                  
               var ctx = document.getElementById('reta_pie_chart').getContext('2d');
               ...
               //Product Bar Graph
               var ctx = document.getElementById('reta_bar_graph').getContext('2d');
               ...
               //Product Line Graph
               var ctx = document.getElementById('reta_line_graph').getContext('2d');
   ...
   $(document).ready(function(){
      ...
      $('body').delegate('.display_waiting_for_approval_div','click',function() {
         window.open($(".display_waiting_for_approval_div").attr("test"),'_blank');
      });
