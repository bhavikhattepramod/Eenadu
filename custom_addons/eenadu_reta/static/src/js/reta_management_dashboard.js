odoo.define('eenadu_reta.mgmt_dashboard', function (require){
   "use strict";
      ...
      render_dashboards: function(){
         ...
         fetchPieChartData: function () {
            ...
            var Charts = self._rpc({
               model: "reta.management.dashboard.data",
   ...
   core.action_registry.add('reta_management_dashboard_tags', reta_dashboard_main);
