...
class SalesCirculationDashboardData(models.Model):
    ...
    def get_display_data(self, unit_name, from_date, to_date):
                            ...
                            for loop_6 in self.env['hr.employee'].search([('parent_id', '=', loop_5.id)]):
                                for loop_7 in self.env['hr.employee'].search([('parent_id', '=', loop_6.id)]):
                                    for loop_8 in self.env['hr.employee'].search([('parent_id', '=', loop_7.id)]):
                                        super_admin_list_name.append(loop_8.user_id.id)
        ...
        if super_admin:
            ...
            # Search for Internal orders created on the Today's unit and all units indent for circulation head
            indent_supplied = self.env['sale.order'].search([('internal_order', '=', True),
                                                             ('unit_name', 'in', circulation_admin),
                                                             ('create_date', '>=', current_day + ' 00:00:00'),
                                                             ('create_date', '<', current_day + ' 23:59:59')])
            for so_line in indent_supplied.order_line:
                if so_line.product_id.is_newspaper == True:
            ...
            # Search for Internal orders created on the Today's unit and all units indent for circulation head
            indent_supplied = self.env['sale.order'].search([('internal_order', '=', True),
                                                             ('unit_name', 'in', circulation_incharge),
                                                             ('create_date', '>=', current_day + ' 00:00:00'),
                                                             ('create_date', '<', current_day + ' 23:59:59')])
            for so_line in indent_supplied.order_line:
                if so_line.product_id.is_newspaper == True:
    ...
    def today_indent_demand(self):
        ...
        if super_admin:
            ...
            return {
                ...
                'domain': [('unit_name', 'in', super_admin), ('id', 'in', indent_supplied.ids)],
        ...
        if circulation_head:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', circulation_head), ('id', 'in', indent_supplied.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
        ...
        if circulation_admin:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', circulation_admin), ('id', 'in', indent_supplied.ids)],
        ...
        if regional_head:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', regional_head), ('id', 'in', indent_supplied.ids)],
                'views': [(self.env.ref('sales_circulation.sale_order_line_tree_view').id or False, 'tree')],
        ...
        if unit_incharge:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', unit_incharge), ('id', 'in', indent_supplied.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
        ...
        if circulation_incharge:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', circulation_incharge), ('id', 'in', indent_supplied.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
        ...
        if publications_incharge:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', publications_incharge), ('id', 'in', indent_supplied.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
        ...
        if field_segment_incharge:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', field_segment_incharge), ('id', 'in', indent_supplied.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
    ...
    def yesterday_indent_supplied(self):
        ...
        if super_admin:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', super_admin), ('id', 'in', indent_supplied_previous_day.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
        ...
        if circulation_head:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', circulation_head), ('id', 'in', indent_supplied_previous_day.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
        ...
        if circulation_admin:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', circulation_admin), ('id', 'in', indent_supplied_previous_day.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
        ...
        if regional_head:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', regional_head), ('id', 'in', indent_supplied_previous_day.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
        ...
        if unit_incharge:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', unit_incharge), ('id', 'in', indent_supplied_previous_day.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
        ...
        if circulation_incharge:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', circulation_incharge), ('id', 'in', indent_supplied_previous_day.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
        ...
        if publications_incharge:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', publications_incharge), ('id', 'in', indent_supplied_previous_day.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
        ...
        if field_segment_incharge:
            ...
            return {
                ...
                'res_model': 'sale.order',
                'context': {'readonly_by_pass': True, 'check_domain': True, 'create': False},
                'domain': [('unit_name', 'in', field_segment_incharge), ('id', 'in', indent_supplied_previous_day.ids)],
                'views': [(self.env.ref('sale.view_order_form').id or False, 'form'),
                          (self.env.ref('sales_circulation.view_internal_order_tree').id or False, 'tree')],
