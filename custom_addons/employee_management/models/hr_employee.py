...
class EmployeeDetailsFields(models.Model):
    ...
    street_emp = fields.Char(required=True)
    street2_emp = fields.Char()
    zip_emp = fields.Char(change_default=True, required=True)
    city_emp = fields.Char()
    state_id_emp = fields.Many2one("res.country.state", string='State', ondelete='restrict', required=True)
    country_id_emp = fields.Many2one('res.country', string='Country', ondelete='restrict', required=True)
    ...
    son_dot_of = fields.Char(required=True)
    son_dot_of2 = fields.Char(required=True)
    ...
    street_permanent = fields.Char(string="Stree", required=True)
    street2_permanent = fields.Char(string="Street2")
    pincode_permanent = fields.Char(change_default=True, string="PIN Code", required=True)
    city_permanent = fields.Char(string="City", required=True)
    state_id_permanent = fields.Many2one("res.country.state", string='State', ondelete='restrict', required=True)
    country_id_permanent = fields.Many2one('res.country', string='Country', ondelete='restrict', required=True)
