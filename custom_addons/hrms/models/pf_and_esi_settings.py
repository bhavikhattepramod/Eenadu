...
class PFandESIsettings(models.Model):
    ...
    eps_salary_limit = fields.Float(string="EPS Salary Limit")
    eps_limit = fields.Float(string="EPS Limit")
...
class PFESIcheckbox(models.Model):
    ...
    gratuity_employee_level = fields.Boolean(string='Gratuity Applicable')
    stop_payment_payroll = fields.Boolean(string='Stop Payment', default=False)
