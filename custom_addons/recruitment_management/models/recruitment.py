...
class Applicant(models.Model):
    ...
    recruiter_name = fields.Char(related='recruiter.identification_id', string='Interviewer Code')
    recruiter2 = fields.Many2one('hr.employee', "Interviewer Name")
    recruiter_name2 = fields.Char(related='recruiter2.identification_id', string='Interviewer Code')
    recruiter3 = fields.Many2one('hr.employee', "Interviewer Name")
    recruiter_name3 = fields.Char(related='recruiter3.identification_id', string='Interviewer Code')
    recruiter4 = fields.Many2one('hr.employee', "Interviewer Name")
    recruiter_name4 = fields.Char(related='recruiter4.identification_id', string='Interviewer Code')
    recruiter5 = fields.Many2one('hr.employee', "Interviewer Name")
    recruiter_name5 = fields.Char(related='recruiter5.identification_id', string='Interviewer Code')
    recruiter6 = fields.Many2one('hr.employee', "Interviewer Name")
    recruiter_name6 = fields.Char(related='recruiter6.identification_id', string='Interviewer Code')
    ...
    def generate_offer_letter(self):
        ...
        if not self.salary_breakup_id:
            raise UserError(_("salary breakup is not selected..!!!"
